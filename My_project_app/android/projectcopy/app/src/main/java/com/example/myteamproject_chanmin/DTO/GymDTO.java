...
public class GymDTO {
    ...
    String gym_id , gym_name ,  address , telephone_number, gym_price , gym_picture ;

    public  GymDTO ( ) {

    }

    public GymDTO(String gym_id, String gym_name, String address, String telephone_number, String gym_price, String gym_picture) {
        this.gym_id = gym_id;
