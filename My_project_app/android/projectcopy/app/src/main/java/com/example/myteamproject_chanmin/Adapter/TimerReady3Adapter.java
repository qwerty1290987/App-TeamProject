...
public class TimerReady3Adapter extends
        RecyclerView.Adapter<TimerReady3Adapter.ViewHolder>{
    ...
    public TimerReady3Adapter(Context context, ArrayList<TimerListDTO2> dtos  ) {
    ...
    public TimerReady3Adapter(Context context, ArrayList<TimerListDTO2> dtos  , MainActivity mainActivity) {
        this.context = context;
        this.dtos = dtos;
        // 화면 붙이는 객체를 생성
        inflater = LayoutInflater.from(context);
    ...
    public TimerReady3Adapter(Context context, ArrayList<TimerListDTO2> dtos  , CenterDetailActivity centerDetailActivity) {
        this.context = context;
        this.dtos = dtos;
        // 화면 붙이는 객체를 생성
        inflater = LayoutInflater.from(context);
